...
public class SamuraiRunState : IState
{
    ...
    public void FixedUpdate()
    {
        ...
        _samurai.transform.GetChild(0).localScale = dir == new Vector2(-1, 0) ? new Vector3(-1, _samurai.transform.GetChild(0).localScale.y, _samurai.transform.GetChild(0).localScale.z) : new Vector3(1, _samurai.transform.GetChild(0).localScale.y, _samurai.transform.GetChild(0).localScale.z);
